    ...
    <div className="min-h-screen">
      ...
      <section className="py-16 sm:py-20 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div
            className="bg-[#111111] rounded-xl p-4 sm:p-6 md:p-8 
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
            {skills.map((skill, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-[#111111] rounded-xl p-4 sm:p-6 
              ...
              <div className="space-y-12">
                ...
                <div className="relative pl-8">
                  ...
                  <div className="bg-[#1a1a1a] rounded-lg p-4 transform transition-all duration-300 hover:scale-[1.02]">
                    ...
                    <p className="text-gray-400 text-sm sm:text-base mb-4">
                      University of Immaculate Conception • 2026
                    </p>
                  ...
                  <div className="bg-[#1a1a1a] rounded-lg p-4 transform transition-all duration-300 hover:scale-[1.02]">
                    ...
                    <p className="text-gray-400 text-sm sm:text-base mb-4">
                      Philippine Academy of Sakya Davao • 2025 - 2026
                    </p>
                ...
                <div className="relative pl-8">
                  ...
                  <div className="bg-[#1a1a1a] rounded-lg p-4 transform transition-all duration-300 hover:scale-[1.02]">
                    ...
                    <ul className="list-disc list-inside text-gray-300 text-sm sm:text-base space-y-2">
                      ...
                      <li>
                        Analyzed social media metrics and prepared performance
                        reports
                      </li>

                      <li>
                        Assisted in developing and implementing marketing
                        campaigns
                      </li>
                    </ul>
                  </div>
                ...
                <div className="relative pl-8">
                  ...
                  <div className="bg-[#1a1a1a] rounded-lg p-4 transform transition-all duration-300 hover:scale-[1.02]">
                    ...
                    <ul className="list-disc list-inside text-gray-300 text-sm sm:text-base space-y-2">
                      <li>
                        Provided administrative support and managed client
                        schedules
                      </li>
